...
╚═╝  ╚═╝╚═════╝ ╚═╝  ╚═══╝╚═╝  ╚═╝╚═╝  ╚═══╝
Author: Adnan Sheikh 
FB:https://www.facebook.com/adnan.tera.real.papa
=========================================="""
logo1 = """
\033[1;91m•~Owner   :  ÆDÑÃÑ Sheikh 
 
  Github   :  ÆDÑÃÑ -Sheikh 

  Facebook : Md Sharif Hossein 
  
  YouTube: N/A
  
  Contact : +8801581469773
=========================================="""
...
os.system("clear")
print (logo)
CorrectUsername = "adnan520"
CorrectPassword = "adnan520"
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
	    ...
	    time.sleep(2)
            ...
            os.system('xdg-open https://www.facebook.com/Rj.Mamun.SPIDERS')
    else:
